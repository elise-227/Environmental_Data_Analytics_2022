...
If plotting one variable then can do in main ggplot, but if more then do in aesthetics of each geom
...
ggplot(subset(PeterPaul.chem.nutrients, depth == 0), aes(x = daynum, y = temperature_C, color = year4)) + facet_wrap(vars(lakename), nrow = 3) + 
ylab("Temperature")+
xlab("Day")+
geom_point()
