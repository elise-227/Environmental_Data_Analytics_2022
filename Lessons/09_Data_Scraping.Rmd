...
the_facility <- '0004-0001' #plant 15
the_year <- 2015
...
scrape.it <- function(the_year, the_facility){
  ...
  Sys.sleep(1) #uncomment this if you are doing bulk scraping! - slow down 
...
the_facility_ids <- the_main_website %>% 
  ...
  html_attr("href") %>%           #Pull the "href" attribute from the node - different from before want the attribute associated not the text 
