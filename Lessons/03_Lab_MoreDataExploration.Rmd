...
```{r}
high_f <- c(49,55,37,38,42,36,45,50,52,51)

low_f <- c(30,31,19,24,27,18,24,29,28,37)
...
```{r}
weather_dur_NC <- data.frame(high_f,low_f, high_c, low_c)
```
...
```{r}
summary(weather_dur_NC)
summary(weather_dur_NC$high_f)
sd(weather_dur_NC$high_f)
```
